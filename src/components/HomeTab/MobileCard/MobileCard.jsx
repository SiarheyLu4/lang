          ...
          {items?.map(
            ({
              ...
              <TransactionList key={_id} color={transactionType}>
                <ListItems>
                  <TitleItems>{t("Date")}</TitleItems>
                  <TextItems>{moment.utc(date).format('DD.MM.YY')}</TextItems>
                </ListItems>
                <ListItems>
                  <TitleItems>{t("Type")}</TitleItems>
                ...
                <ListItems>
                  <TitleItems>{t("Category")}</TitleItems>
                  <TextItems>{Categories(category)}</TextItems>
                </ListItems>
                <ListItems>
                  <TitleItems>{t("Comment")}</TitleItems>
                  <TextItems>
                    <EllipsisText
                      text={`${comment || '---'}`}
                      length={17}
                ...
                <ListItems>
                  <TitleItems>{t("Balance")}</TitleItems>
